  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <div className="relative h-[60vh] w-full overflow-hidden">
        ...
        <div className="absolute inset-0 z-20 flex items-center justify-center">
          <div className="text-center text-white max-w-4xl px-4">
            <h1 className="text-5xl md:text-6xl font-bold mb-6">Career at <span className="text-orange-500">Ikonic</span> Limousine</h1>
            <p className="text-xl md:text-2xl font-light">Luxury in Motion, Excellence in Service</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-16 md:py-24">
          ...
          <div className="w-full flex justify-center overflow-hidden">
            <div className="relative w-[1300px] h-[350px]">
              <div
                ...
                style={{
                  transform: `translateX(-${current * (400 + 48)}px)`,
                  width: `${carouselImages.length * (400 + 48)}px`,
                }}
              >
                {[...carouselImages, ...carouselImages.slice(0, 2)].map((src, idx) => (
                  <div key={idx} className="flex-shrink-0 w-[400px] h-[350px] mr-12">
                    <img
                      src={src}
        ...
        {/* Why Join Us Section */}
        <div className="bg-gray-50 rounded-2xl p-12 md:p-16 mb-24">
          <h2 className="text-4xl font-bold text-gray-900 mb-12 text-center">Why Join <span className="text-orange-500">Us</span>?</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 border-2 border-transparent transition-all duration-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Prestigious Brand</h3>
                <p className="text-gray-600 leading-relaxed">
                  Be part of a premium limousine service known for elegance, professionalism, and excellence in every journey.
                </p>
              </div>
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 border-2 border-transparent transition-all duration-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Meaningful Impact</h3>
                <p className="text-gray-600 leading-relaxed">
            ...
            <div className="space-y-8">
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 border-2 border-transparent transition-all duration-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Supportive Environment</h3>
                <p className="text-gray-600 leading-relaxed">
              ...
              <div className="bg-white p-8 rounded-xl shadow-sm hover:shadow-md hover:border-orange-200 border-2 border-transparent transition-all duration-300">
                <h3 className="text-2xl font-bold text-gray-800 mb-4">Authentic You</h3>
                <p className="text-gray-600 leading-relaxed">
      ...
      <div 
        className="relative min-h-[500px] w-full flex items-center justify-center"
        style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto text-center text-white px-4">
          <p className="text-2xl md:text-3xl leading-relaxed mb-10 font-light">
          ...
          <button className="bg-orange-500 text-white px-12 py-4 rounded-lg font-semibold text-lg hover:bg-orange-600 transition-colors duration-300">
            Join our team
          </button>
        </div>
      </div>
